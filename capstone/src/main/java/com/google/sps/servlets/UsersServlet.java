...
public class UsersServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      IsUserRegistered = IsUserRegistered(pool, userService, GET_USER_ROW_QUERY, response, request);
      if (!IsUserRegistered) {
    ...
    String userResult;
    try {
      HashMap<String, String> userDetails = retrieveExistingUserInfo(pool, userService, GET_USER_ROW_QUERY, response, request);
   ...
   * @param userService This is a UserService object that holds information about the current user.
   * @param response A HttpServletResponse object that holds the information that will be sent back to the user.
   * @param result_parameters  A HashMap object that holds all the information sent in the "body" of the user's request.
   * @return Boolean
   */
