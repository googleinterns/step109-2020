...
public class ValidateEmailServlet extends HttpServlet {
  ...
  /**
   * This method checks if the email supplied is a student email by confirming the '@google.com' tld.
  ...
  public void checkForStudentEmail(
    ...
    if (!email.endsWith("@google.com")) {
      ...
      response.sendRedirect(
        "/badLogin.html?error=requires-google-email&logoutUrl=" + logoutUrl
      );
      return;
    }
