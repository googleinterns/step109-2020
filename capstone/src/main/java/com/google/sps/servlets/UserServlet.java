...
public class UserServlet extends HttpServlet {
   ...
   */
  public HashMap<String, String> getUserDetails(DataSource pool, UserService userService, String get_user_row_query, HttpServletResponse response) throws SQLException, IOException{
    ...
    if (isUserLoggedIn) {
        ...
        try(Connection conn = pool.getConnection()){
            try(PreparedStatement queryStatement = conn.prepareStatement(get_user_row_query)) {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
        HashMap<String, String> userDetails = getUserDetails(pool, userService, get_user_row_query, response);
   ...
   * @return void
   */
  public void saveUserDetails(DataSource pool, UserService userService, HttpServletRequest request) throws  SQLException {
    try(Connection conn = pool.getConnection()) {
        try(PreparedStatement queryStatement = conn.prepareStatement(create_new_user_query)){
            String full_name = request.getParameter("full_name");
            String user_name = request.getParameter("user_name");
            Integer university_id = Integer.valueOf(request.getParameter("university"));
